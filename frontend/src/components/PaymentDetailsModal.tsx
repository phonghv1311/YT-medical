...
export default function PaymentDetailsModal({ pkg, onSuccess, onClose }: Props) {
  ...
  const displayPrice = Number(pkg.price);
      ...
      <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-2xl shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <p className="text-xs text-gray-500 text-center">
            By clicking &quot;Pay Now&quot;, you agree to our <Link to="/terms" className="text-blue-600 underline" onClick={onClose}>Terms of Service</Link> and <Link to="/subscription" className="text-blue-600 underline" onClick={onClose}>Subscription Agreement</Link>.
          </p>
        </div>
      </div>
    </div>
